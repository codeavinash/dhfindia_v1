...
class LocationTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        CountryStates::truncate();
        StatesDistricts::truncate();
        ...
        $statesList = ['Andhra Pradesh'=>[
            ...
            ],'Arunachal Pradesh'=>['Anjaw' , 'Changlang' , 'Dibang Valley' , 'East Kameng' , 'East Siangl',
            ...
            'Tinsukia' , 'Udakguri' , 'West Karbi Anglong' ,
            ...
            'Vaishali' , 'West Champaran'
                ...
                'Sukma' , 'Surajpur' , 'Surguja' , 'Gaurela-Pendra-Marwahi',
                ],'Goa'=>[
                    'North Goa' , 'South Goa'
                    ],'Gujarat'=>[
                        ...
                        ],'Haryana'=>['Ambala' , 'Bhiwani' , 'Charkhi Dadri' , 'Faridabad' , 'Gurgaon',
                                                ...
                                                'Nuapada' , 'Puri' , 'Rayagada' , 'Sambalpur' , 'Subarnapur' , 'Sundargarh'
                                                    ...
                                                    'Sri Ganganagar' , 'Tonk' , 'Udaipur',
                                                        ...
                                                        'Kallakurichi' , 'Mayiladuthurai',
                                                            ...
                                                            'Warangal (Rural)' , 'Warangal (Urban)' , 'Yadadri Bhuvanagiri' , 'Mulugu',
                                                            'Narayanpet',
                                                            ],'Tripura'=>['Dhalai' , 'Gomati' , 'Khowai' , 'North Tripura',
                                                            'Sepahijala' ,' South Tripura' , 'Unakoti' , 'West Tripura',
                                                            ],'Uttar Pradesh'=>['Agra' , 'Aligarh' , 'Allahabad' , 'Ambedkar Nagar' , 'Amethi (Chatrapati sahuji Mahraj Nagar)' , 'Amroha (J.P.Nagar)' , 'Auraiya',
                                                            'Azangarh' , 'Baghpat' , 'Bahraich' , 'Ballia' , 'Balrampur' , 'Banda' , 'Barabanki',
                                                            'Bareilly' , 'Basti' , 'Bhadohi' , 'Bijnor' , 'Budaun' , 'Buldandshahr' , 'Chandauli',
        ...
        Andaman and Nicobar Island'=>[
            ...
            ],'Chandigarh'=>['Chandigarh'],'Dadra and Nagar Haveli'=>['Dadra and Nagar Haveli'],'Daman and Diu'=>[
                'Daman', 'Diu'
                ],'Delhi'=>[
                    'Central Delhi ', 'East Delhi' , 'New Delhi' , 'North Delhi',
                    'North East Delhi' , 'North West Delhi' , 'Shahdara' , 'South Delhi',
                    'South East Delhi' , 'South West Delhi' , 'West Delhi',
                    ],'Jammu and Kashmir'=>['Anantnag' , 'Bandipore' , 'Baramulla' , 'Budgam' , 'Doda',
                    'Ganderbal' , 'Jammu' , 'Kathua' , 'Kishtwar' , 'Kulgam',
                    'Kupwara' , 'Poonch' , 'Pulwama' , 'Mirpur' , 'Muzaffarabad',
                    'Rajouri' , 'Ramban' , 'Reasi' , 'Samba' , 'Shopian',
                    'Srinagar' , 'Udhampur' ,
                    ],'Ladakh'=>[
                        'Kargil' , 'Leh',
                        ],'Lakshadweep'=>['Lakshadweep'],'Puducherry'=>[
                            'Karaikal' , 'Yanam',
                            'Mahe' , 'Pondicherry',
                            ]];
