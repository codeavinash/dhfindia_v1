...
<body> 
    ...
    <div class="displayBox">
        ...
        <a href="[<?php echo e($displayableActionUrl); ?>](<?php echo e($actionUrl); ?>)" class="button">click here</a>
        <a href="<?php echo e($displayableActionUrl); ?>" class="button">click here</a>
...
</html><?php /**PATH /opt/lampp/htdocs/dhfindia/resources/views/vendor/notifications/email.blade.php ENDPATH**/ ?>