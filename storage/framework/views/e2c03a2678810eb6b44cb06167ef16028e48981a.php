...
<link rel="stylesheet" href="<?php echo e(asset('css/pages/users/joinUs.css')); ?>">
<script src="<?php echo e(asset('js/pages/joinus.js')); ?>" defer></script>
...
<div class="titleImage f-jc-ac">
    ...
    <div class='formContainer'>
        ...
        <form action="<?php echo e(route('user.joinusForm')); ?>" method="post" enctype="multipart/form-data">

            <?php echo csrf_field(); ?>

            <label for="picIn" id="profilePic" class="f-jc-ac" style="background-image:url('<?php echo e(asset(Auth::user()->profilepic)); ?>') "><i class="im im-cloud-upload"></i>upload a profile image</label>
            ...
            <input type="text" name="fulname" id="fulname" class="cutInput" value="<?php echo e(Auth::user()->name); ?>" required>

            <label for="mobile">enter mobile number <strong>*same number as per loged in</strong></label>
            <input type="number" name="mobileNumber" id="mobile" class="cutInput" value="<?php echo e(Auth::user()->number); ?>" required>
            ...
            <input type="email" name="email_id" id="email" value="<?php echo e(Auth::user()->email); ?>" required>

            <label for="state">state</label>
            <select name="state" id="state" required>
                <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($state->id); ?>"><?php echo e($state->stateName); ?></option>
    ...
    <div class="payment">
        <img src="<?php echo e(asset('networkingFiles/images/paymet_barcode/WhatsApp Image 2020-10-04 at 8.09.52 AM.jpeg')); ?>" alt="" srcset="">
    </div>

    
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/dhfindia/resources/views/Users/joinUs.blade.php ENDPATH**/ ?>