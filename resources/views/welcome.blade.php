...
<div class="Overflow-main-card-container f jc ac" style="background-image: linear-gradient(rgba(255, 166, 0, 0.678),rgba(255, 166, 0, 0.678)),url('{{ asset('images/backgroundimageOne.jpg') }}');">
    <div class="Overflow-main-container f ja ab animatedParent">
        <div class="overflow-Card animated fadeInUpShort" >
            ...
            <h2>vission</h2>
            <p>To set up multiple branches across the country to support Education, Health & Environment. Take our Objectives to max.</p>
        ...
        <div class="overflow-Card animated fadeInUpShort" >
            ...
            <h2>mission</h2>
            <p>To lead to change thinking & devlopment of society. And provide Unity platform for Needy.</p>
        ...
        <div class="overflow-Card animated fadeInUpShort" >
            ...
            <h2>donation</h2>
            <p>To carry many program to accomplish the requirements of the needful.</p>
        </div>
...
<div class="three-welcome-post-container">
    <div class="three-welcome-post-content-container f ja ac animatedParent" >
        ...
        <div class="three-text-box-container animated bounceInRight delay-250">
            ...
            <p>We , DINBANDHU HELP FOUNDATION (Team of Young College Students) started on the day, 15 August 2018 from Ratanpur, Bilaspur (C.G.) with the thought "JAN JAGRUKTA KE MADHYAM SE SAMAJ KA VIKAS"</p>
...
<div class="OurCause-section-container increaseHeight animatedParent">
...
<div class="Center-Achivment-Box" style="background-image: linear-gradient(rgba(0, 0, 0, 0.8),rgba(0, 0, 0, 0.8)),url('{{ asset('images/backgroundimageTow.jpg') }}');">
  ...
  <div class="OurCause-section-container">
    ...
    <p class="cause-short-desscription">
        Some of our memorable moment captured in shots.
Every shot itself tells a remarkable story
    </p>
